...
class GlobalSettings {
    ...
    loadSettings() {
        const saved = localStorage.getItem('speedcubestudio_settings');
        if (saved) {
            try {
    ...
    applyGlobalSettings() {
        ...
        window.addEventListener('storage', (e) => {
            if (e.key === 'speedcubestudio_settings') {
                this.settings = this.loadSettings();
                this.applyGlobalSettings();
    ...
    updateSetting(key, value) {
        ...
        localStorage.setItem('speedcubestudio_settings', JSON.stringify(this.settings));
        
        console.log('Updated settings:', this.settings);
        console.log('Saved to localStorage:', localStorage.getItem('speedcubestudio_settings'));
